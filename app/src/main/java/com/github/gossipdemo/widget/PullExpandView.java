...
public class PullExpandView extends LinearLayout {
    ...
    private void addCompTextView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.view_pull_expand, null, false);
    ...
    public FrameTextView getTvComp() {
        return tvComp;
    }
     ...
     * 重置 tv 布局参数
     */
    public void resetTvCompParams() {
        tvComp.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout
