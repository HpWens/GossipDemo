...
public class RadiusDrawable extends Drawable {
  ...
  public static final String TAG = "RadiusDrawable";
  ...
  public RadiusDrawable(Bitmap bitmap) {
    mBitmap = bitmap;
  ...
  public static RadiusDrawable fromBitmap(Bitmap bitmap) {
    if (bitmap != null) {
      return new RadiusDrawable(bitmap);
    } else {
      return null;
    }
  }
  ...
  public static Drawable fromDrawable(Drawable drawable) {
    if (drawable != null) {
      if (drawable instanceof RadiusDrawable) {
        // just return if it's already a RadiusDrawable
        return drawable;
   ...
   * @return the {@link RadiusDrawable} for chaining.
   */
  public RadiusDrawable setCornerRadius(float radius) {
   ...
   * @return the {@link RadiusDrawable} for chaining.
   */
  public RadiusDrawable setCornerRadius(@Corner int corner, float radius) {
   ...
   * @return the {@link RadiusDrawable} for chaining.
   */
  public RadiusDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                        float bottomLeft) {
  ...
  public RadiusDrawable setBorderWidth(float width) {
    mBorderWidth = width;
    mBorderPaint.setStrokeWidth(mBorderWidth);
    return this;
  }
  ...
  public RadiusDrawable setBorderColor(@ColorInt int color) {
  ...
  public RadiusDrawable setBorderColor(ColorStateList colors) {
  ...
  public RadiusDrawable setOval(boolean oval) {
    mOval = oval;
    return this;
  }
  ...
  public RadiusDrawable setScaleType(ScaleType scaleType) {
    if (scaleType == null) {
  ...
  public RadiusDrawable setTileModeX(Shader.TileMode tileModeX) {
  ...
  public RadiusDrawable setTileModeY(Shader.TileMode tileModeY) {
